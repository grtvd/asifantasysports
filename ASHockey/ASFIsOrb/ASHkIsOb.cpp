...
USEUNIT("Source\ASHockeyHtmlObjectServer.cpp");
USEUNIT("Source\ASHockeyOrbFulfiller.cpp");
USEUNIT("Source\ASHockeyPlayerScoutRqst.cpp");
USEUNIT("Source\ASHockeyLineupQueryRqst.cpp");
USEUNIT("Source\ASHockeyLineupUpdateRqst.cpp");
//---------------------------------------------------------------------------
